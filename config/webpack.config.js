...
module.exports = function(webpackEnv) {
  ...
  const getStyleLoaders = (cssOptions, preProcessor, restLoaders) => {
    let loaders = [
      ...
      isEnvProduction && {
        ...
        // css is located in `static/css`, user '../../' to locate index.html folder
  ...
  return {
    ...
    entry: [
      ...
      // Note: instead of the default WebpackDevServer client, we user a custom one
    ...
    output: {
      ...
      // There are also additional JS chunk files if you user code splitting.
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            // In production, we user MiniCSSExtractPlugin to extract that CSS
            ...
            // This loader doesn't user a "test" so it will catch all modules
    ...
    plugins: [
      ...
      // Watcher doesn't work well if you mistype casing in a path so we user
      ...
      // You can remove this if you don't user Moment.js:
    ...
    // Some libraries import Node modules but don't user them in the browser.
