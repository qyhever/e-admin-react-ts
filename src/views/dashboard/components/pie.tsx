...
const PieChart = () => {
  ...
  const [disabledLegendIndexs, setDisabledLegendIndexs] = useState<number[]>([])
  const list = useRef<echarts.EChartOption.SeriesPie.DataObject[]>([])
  ...
  function onLegendItemClick(clickIndex: number) {
    let scopeDisabledLegendIndexs: number[] = []
